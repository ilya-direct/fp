...
<head>
	...
	<link rel="stylesheet" href="<?=$this->baseurl ?>/templates/<?php echo $this->template; ?>/css/print.css" type="text/css" />
<?php if ($this->direction == 'rtl') : ?>
	<link rel="stylesheet" href="<?=$this->baseurl ?>/templates/<?php echo $this->template ?>/css/template_rtl.css" type="text/css" />
<?php endif; ?>
<!--[if IE 6]>
<link rel="stylesheet" href="<?=$this->baseurl ?>/templates/<?php echo $this->template ?>/css/ie6.css" type="text/css" />
<![endif]-->
<!--[if lte IE 7]>
